...
public class GetStartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preference.get_second_ads().equalsIgnoreCase("ON")) {
            ...
            new All_Ads_Config(this).Native_Ads(findViewById(R.id.native_container));
            ads();
        }
        recycler_native2 = (RecyclerView) findViewById(R.id.recycler_native2);
        new All_Ads_Config(this).Native_Ads(findViewById(R.id.native_container2));
        ads2();

        playgames = (ImageView) findViewById(R.id.playgames);
        playgames.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(GetStartActivity.this, StartActivity.class);
                startActivity(i);
            }
        });
    }
    ...
    private void nativeCategory() {
        ...
        reference.child(NATIVE_CATEGORY).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull @org.jetbrains.annotations.NotNull DatabaseError databaseError) {
                Toast.makeText(GetStartActivity.this, "error" + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
            new AlertDialog.Builder(GetStartActivity.this).setMessage("Do you want to exit ?")
