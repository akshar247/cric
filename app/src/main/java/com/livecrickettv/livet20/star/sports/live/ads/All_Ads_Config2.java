...
public class All_Ads_Config2 {
    ...
    public All_Ads_Config2(Activity activity) {
    ...
    private void Admob_First_Small_Native_Ads(final ViewGroup viewGroup) {
        try {
            adLoader = new AdLoader.Builder(activity, preference.get_admob_native_advance_id_2())
                    ...
                    moPubView.setBannerAdListener(new MoPubView.BannerAdListener() {
                        ...
                        public void onBannerFailed(MoPubView moPubView, MoPubErrorCode moPubErrorCode) {
                           ...
                           /*     final AdView adView = new AdView(activity);
                                ...
                                adView.setAdUnitId(preference.get_admob_banner_id_2());
