...
public class NativeAppAdapter extends RecyclerView.Adapter<NativeAppAdapter.MyViewHolder> {
    ...
    public NativeAppAdapter(Context context, ArrayList<NativeApp> gunList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.native_custom, parent, false);
