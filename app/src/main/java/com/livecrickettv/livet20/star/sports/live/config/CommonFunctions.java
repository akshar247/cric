...
import static com.livecrickettv.livet20.star.sports.live.config.Constants.BITMAP_SCALE;
...
import com.livecrickettv.livet20.star.sports.live.reciver.ConnectivityReceiver;
...
public class CommonFunctions {
    ...
    public static boolean createDirs(String filePath) {
        com.livecrickettv.livet20.star.sports.live.config.Logger.debugE(filePath.substring(0, filePath.lastIndexOf("/")));
        java.io.File f = new java.io.File(filePath.substring(0, filePath.lastIndexOf("/")));
        com.livecrickettv.livet20.star.sports.live.config.Logger.debugE(f.mkdirs() + "");
        return f.mkdirs();
    }
   ...
   /* public static void alertboxshow(final Activity activity) {
    ...
    public static String getDeviceUID(Activity activity) {
        try {
            ...
            com.livecrickettv.livet20.star.sports.live.config.Logger.debugE(e.toString());
            if (e.getMessage() == null) {
                com.livecrickettv.livet20.star.sports.live.config.Logger.debugE("" + " getDeviceUID : ");
            } else {
                com.livecrickettv.livet20.star.sports.live.config.Logger.debugE("" + " getDeviceUID : " + e.getMessage());
