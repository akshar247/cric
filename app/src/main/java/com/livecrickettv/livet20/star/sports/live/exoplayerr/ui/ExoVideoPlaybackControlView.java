package com.livecrickettv.livet20.star.sports.live.exoplayerr.ui;
...
import com.livecrickettv.livet20.star.sports.live.exoplayerr.gesture.OnVideoGestureChangeListener;
import com.livecrickettv.livet20.star.sports.live.exoplayerr.gesture.VideoGesture;
import com.livecrickettv.livet20.star.sports.live.exoplayerr.media.ExoMediaSource;
import com.livecrickettv.livet20.star.sports.live.exoplayerr.orientation.OnOrientationChangedListener;
import com.livecrickettv.livet20.star.sports.live.exoplayerr.orientation.SensorOrientation;
...
import static com.livecrickettv.livet20.star.sports.live.exoplayerr.orientation.OnOrientationChangedListener.SENSOR_UNKNOWN;
...
//    <!--<enum getDisplayName="bottom_landscape" value="0b0001"/>-->
    ...
    public RelativeLayout native_center;
    ...
    public ExoVideoPlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        native_center=findViewById(R.id.nativeads);
        native_center.setVisibility(View.GONE);
        recycler_native = (RecyclerView) findViewById(R.id.recycler_native);
     //   new All_Ads_Config().Native_Ads(findViewById(R.id.native_container));
       // ads();
      //  new All_Ads_Config().Small_Native_Ads(findViewById(R.id.native_container2));
        ...
        public void onClick(View view) {
            if (player != null) {
                if (nextButton == view) {
                    ...
                    native_center.setVisibility(GONE);
                    controlDispatcher.dispatchSetPlayWhenReady(player, true);
                } else if (pauseButton == view || pauseButtonLandScape == view) {
                    native_center.setVisibility(VISIBLE);
                    controlDispatcher.dispatchSetPlayWhenReady(player, false);
                    ...
                    ((SimpleVideoViewActivity)getContext()).banner.setVisibility(View.GONE);
                    changeOrientation(SENSOR_LANDSCAPE);
                } else if (exitFullscreen == view) {

                    ((SimpleVideoViewActivity)getContext()).banner.setVisibility(View.VISIBLE);
                    changeOrientation(SENSOR_PORTRAIT);
        ...
        private void playOrPause() {
            ...
            if (500 > (SystemClock.uptimeMillis() - mHits[0])) {
                ...
                if (playy){
                    ...
                    native_center.setVisibility(View.VISIBLE);
                    playy=true;
                }
    ...
    private void ads() {
        ...
        nativeAppAdapter = new NativeAppAdapter(getContext(), nativeAppArrayList);
        recycler_native.setNestedScrollingEnabled(false);
        GridLayoutManager gridLayoutManager1;
        gridLayoutManager1 = new GridLayoutManager(getContext(), 1) {
            @Override
